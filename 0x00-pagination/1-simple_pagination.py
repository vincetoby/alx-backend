#!/usr/bin/env python3
"""
this Defines class Server that paginates a database of popular baby names
"""
import csv
import math
...
class Server:
    """this is a class tpo paginate a database of popular baby names.
    """
    ...
    def get_page(self, page: int = 1, page_size: int = 10) -> List[List]:
        """
        this takes 2 integer args and returns requested page from the dataset
        Args:
            page (int): required page number and must be a positive integer
            page_size (int): number of records per page and 
